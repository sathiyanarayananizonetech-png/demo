...
import { ArrowRight, MapPin, Phone, Award, Shield, Star } from "lucide-react";
...
import spa1 from "../../assets/spa_treatment.png";
import nail1 from "../../assets/nail_art.png";
import service1 from "../../assets/services/serviceimg1.jpeg";
import service2 from "../../assets/services/serviceimg2.jpeg";
import service3 from "../../assets/services/serviceimg3.jpeg";
import team1 from "../../assets/makeup_artist.png";
import team2 from "../../assets/bridal makeup2.png";
...
export function ParlourMobileView() {
  ...
  // Background stays largely pinned but zooms slightly
  ...
  // Content moves up faster than the scroll (parallax)
    ...
    <div className="bg-background text-on-surface antialiased min-h-screen pb-24">
      ...
      >
        ...
        >
          ...
          >
            <img
              ...
              className="w-full h-full object-cover object-top motion-safe:animate-[pulse_12s_ease-in-out_infinite]"
            />
          </motion.div>
        ...
        >
          <div className="space-y-4">
            ...
            >
              Step into a world where precision meets passion. Our curated
              journey through the art of transformation.
            </motion.p>
          </div>
      ...
      <section className="py-6 px-0 overflow-hidden">
        <div className="px-6 mb-6 text-center space-y-1">
          <span className="text-primary text-[9px] uppercase font-black tracking-[0.3em]">
            Curated Collections
          </span>
          <h2 className="text-2xl font-bold text-on-surface">
            Signature Rituals
          </h2>
          <p className="text-on-surface/60 text-[10px] max-w-[260px] mx-auto">
            Discover our most celebrated beauty experiences designed for lasting
            radiance.
          </p>
        </div>
      ...
      <section className="bg-surface-dim/30 py-6 px-6">
        <div className="mb-8 text-center space-y-1">
          ...
          <p className="text-on-surface/60 text-[10px] max-w-[260px] mx-auto">
            Masterful treatments using premium botanicals for your unique
            aesthetic journey.
          </p>
        </div>
      ...
      <section className="py-6 px-6 bg-surface-dim/30">
        ...
        >
          {[
            {
              icon: <Award className="text-primary mb-2" size={24} />,
              title: "Expert",
              desc: "Certified Artists",
            },
            {
              icon: <Shield className="text-primary mb-2" size={24} />,
              title: "Pure",
              desc: "Organic Products",
            },
            {
              icon: <Star className="text-primary mb-2" size={24} />,
              title: "Elite",
            ...
            >
              ...
              <p className="text-[9px] text-on-surface/50 mt-1 leading-tight">
                {pill.desc}
              </p>
            </motion.div>
          ))}
      ...
      {/* Zen Tonez Spirit */}
      {/* Zen Tonez Spirit - Balanced padding to accommodate floating asset */}
      <section className="bg-background pt-20 pb-8 px-6 relative">
        ...
        <motion.div
          ...
          className="bg-primary/5 backdrop-blur-md p-6 pt-24 rounded-[2.5rem] border border-primary/20 shadow-lg relative z-10 text-center"
        >
          <p className="text-on-surface leading-relaxed mb-10 text-[14px] italic font-medium">
            "More than a salon, Zen Tonez is a sanctuary for those who
            appreciate the finer details of self-care and the art of individual
            expression."
          </p>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="absolute -top-10 left-1/2 -translate-x-1/2 w-32 h-32 rounded-full overflow-hidden border-[6px] border-white shadow-luxury-deep z-20 luxury-float"
          >
            <img
      ...
      <section className="bg-surface-dim/20 py-6 px-6">
        <div className="text-center mb-8 space-y-2">
          ...
          <p className="text-on-surface/60 text-xs max-w-[260px] mx-auto">
            A glimpse into our world of bespoke transformations and creative
            precision.
          </p>
        </div>
        ...
        >
          ...
          <motion.div
            variants={itemVariants}
            whileTap={{ scale: 0.98 }}
            className="col-span-2 aspect-video rounded-2xl overflow-hidden shadow-sm"
          >
            <img
              src={service3}
              alt="Work 3"
      ...
      <section className="py-12 px-6 bg-surface-dim/40 rounded-t-[3rem] -mt-8 relative z-10 shadow-luxury-soft">
        <div className="text-center mb-6 space-y-2">
          ...
          <h2 className="text-3xl font-bold text-on-surface leading-tight">
            Elite{" "}
            <span className="italic font-serif text-primary">Artists</span>
          </h2>
          <p className="text-on-surface/50 text-xs max-w-[200px] mx-auto">
            Internationally certified experts at your service.
          </p>
        </div>
      ...
      <section className="py-6 px-6">
        <div className="bg-surface-dim/40 rounded-[2.5rem] p-8 py-12 space-y-10 shadow-xl border border-white relative overflow-hidden text-center">
          ...
          <div className="relative space-y-4">
            ...
            <p className="text-on-surface/70 text-[13px] leading-relaxed font-medium max-w-[240px] mx-auto">
              Step into our sanctuary for a bespoke beauty experience tailored
              just for you.
            </p>
          </div>
          ...
          <div className="relative space-y-6 max-w-[240px] mx-auto">
            <div className="flex items-center justify-center gap-4">
              ...
              <span className="text-[11px] font-medium text-on-surface text-left">
                Thillai Nagar, Trichy, Tamil Nadu
              </span>
            </div>
            <div className="flex items-center justify-center gap-4">
              <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
