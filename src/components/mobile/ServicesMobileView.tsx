...
const mainServices = [
  {
    ...
    price: "₹1,250+",
    description:
      "A bespoke architectural cut designed to enhance your natural bone structure and hair texture.",
    image: img1,
  },
  {
    id: "02",
    ...
    price: "₹3,500+",
    description:
      "Hand-painted highlights for a sun-kissed, dimensional look that grows out beautifully.",
    image: img2,
  },
  {
    id: "03",
    ...
    price: "₹1,800+",
    description:
      "A revitalizing treatment using plant-based essences to nourish and strengthen your hair from the root.",
    image: img3,
  },
  {
    id: "04",
    ...
    price: "₹2,500",
    description:
      "A multi-sensory journey involving deep sonic cleansing and a gold-infused glow mask.",
    image: img4,
  },
  {
    id: "05",
    ...
    price: "₹3,200",
    description:
      "Advanced exfoliation that smooths fine lines and reveals your most radiant, youthful skin.",
    image: img5,
  },
  {
    id: "06",
    ...
    price: "₹4,500",
    description:
      "Intense hydration and oxygenation for immediate plumping and long-term skin health.",
    image: img6,
  },
  {
    id: "07",
    ...
    price: "₹2,800",
    description:
      "A sophisticated makeup ritual tailored for high-profile events and evening galas.",
    image: img11,
  },
  {
    id: "08",
    ...
    price: "₹2,200",
    description:
      "Full body relaxation using premium essential oils to melt away stress and muscle tension.",
    image: img8,
  },
  {
    id: "09",
    ...
    price: "₹3,500",
    description:
      "Premium chocolate wax treatment for a perfectly smooth, painless, and glowing skin experience.",
    image: img9,
  },
  {
    id: "10",
    ...
    price: "₹4,000",
    description:
      "A luxurious body treatment that removes dead skin cells and leaves you with a silken finish.",
    image: img10,
  },
];
...
export function ServicesMobileView() {
  ...
  return (
    <div className="bg-background font-sans text-on-surface antialiased overflow-x-hidden pb-32 max-w-lg mx-auto">
      ...
      >
        ...
        >
          <div className="space-y-4">
            ...
            >
              Discover a curated collection of rituals designed to enhance your
              natural essence and radiance.
            </motion.p>
          </div>
          ...
          <div className="flex flex-col items-center gap-8">
            <motion.button
              ...
              onClick={() =>
                document
                  .getElementById("treatment-gallery")
      ...
      >
        <p className="uppercase tracking-[0.2em] text-[10px] text-primary font-bold">
          Curated Excellence
        </p>
        ...
        {mainServices.map((service) => (
          <section key={service.id} className="px-6 space-y-6">
            <div className="flex items-baseline justify-between border-b border-primary/10 pb-2">
              <h2 className="uppercase tracking-widest text-sm font-bold text-primary">
                {service.category}
              </h2>
      ...
      <section className="bg-surface-dim/40 -mx-6 p-10 space-y-10 rounded-t-[3rem] shadow-[inset_0_20px_40px_rgba(0,0,0,0.05)] mt-12">
        ...
        >
          <h2 className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#C9A24A]">
            Specialty Collections
          </h2>
          <p className="font-serif text-3xl text-[#2B2B2B] italic">
            The Artisanal Extras
          </p>
        </motion.div>
        ...
        >
          {specialtyServices.map((specialty, i) => (
            ...
            >
              ...
              <div className="h-32 bg-white rounded-2xl flex flex-col items-center justify-center p-4 text-center shadow-sm border border-primary/5">
                ...
                <span className="font-bold text-[14px] mt-1 leading-tight text-[#2B2B2B]">
                  {specialty.title}
                </span>
                <span className="font-bold text-[#C9A24A] mt-1 text-sm">
                  {specialty.price}
                </span>
              </div>
            </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            whileTap={{ scale: 0.98 }}
            className="col-span-2 relative h-48 overflow-hidden rounded-4xl shadow-xl border-4 border-white mt-4"
          >
            <motion.img
              className="w-full h-full object-cover"
              src={img7}
            ...
            <div className="absolute inset-0 bg-linear-to-t from-black/60 to-transparent flex items-end p-8">
              <div className="space-y-2">
                <span className="text-white text-[10px] font-bold tracking-[0.3em] uppercase opacity-70">
                  Signature Package
                </span>
                <h3 className="text-white text-2xl font-serif italic">
                  The Bridal Concierge
                </h3>
                <Link to="/contact">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
      ...
      <section className="text-center py-16 space-y-8 bg-surface-dim/20 rounded-b-[3rem] px-6">
        <motion.div
          ...
          className="space-y-3"
        >
          <h2 className="text-3xl font-bold tracking-tight text-[#2B2B2B]">
            Need a Bespoke{" "}
            <span className="italic font-serif text-[#C9A24A]">
              Consultation?
            </span>
          </h2>
          <p className="text-[#2B2B2B]/60 max-w-xs mx-auto font-medium">
            Our master artisans are here to guide your transformation.
          </p>
        </motion.div>
