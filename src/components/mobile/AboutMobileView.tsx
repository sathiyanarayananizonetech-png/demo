    ...
    <div className="bg-background text-on-surface antialiased pt-24 pb-32">
      ...
      >
        ...
        <motion.div
          ...
          className="relative z-10 text-center space-y-6 px-4 -mt-28"
        >
          <motion.div
          ...
          <h1 className="text-display font-pacifico leading-none normal-case drop-shadow-luxury">
            <SparkleHeading
              text="Crafting Boutique"
      ...
      <section className="px-8 space-y-10 mb-24">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-bold uppercase tracking-widest text-[#C9A24A]">
              The Vision
            </h2>
          </div>
          <p className="text-lg leading-relaxed text-[#2B2B2B]/80 font-medium">
            Founded on the belief that beauty is an{" "}
            <span className="italic font-serif text-[#C9A24A]">
              intimate art form
            </span>
            , Zen Tonez was born to provide more than just services—we provide a
            sanctuary.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl font-serif italic text-[#2B2B2B]/90 leading-tight">
            "Our mission is to unveil the radiant essence that already exists
            within every client who walks through our doors."
          </p>
      ...
      <section className="bg-[#E8E4DD]/40 py-10 px-8 rounded-[3rem] mb-24 border border-white/20">
        <motion.div
          ...
          className="mb-8"
        >
          <span className="text-[9px] uppercase tracking-[0.3em] text-[#C9A24A] font-bold block mb-1">
            The Difference
          </span>
          <h2 className="text-2xl font-bold text-[#2B2B2B] leading-tight">
            Why We{" "}
            <span className="italic font-serif text-[#C9A24A]">Stand Out</span>
          </h2>
        </motion.div>
          ...
          {[
            {
              ...
              desc: "Connecting you with top beauty professionals.",
            },
            {
              icon: <GraduationCap size={20} />,
              title: "Trained Masters",
              desc: "Skilled and certified international experts.",
            },
            {
              icon: <Package size={20} />,
              title: "Branded Rituals",
              desc: "Premium products from trusted global brands.",
            },
            {
              icon: <ShieldCheck size={20} />,
              title: "100% Hygienic",
              desc: "Medical-grade cleanliness for your safety.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-[#2B2B2B]/60 text-sm leading-relaxed font-medium">
                  {item.desc}
                </p>
              </div>
            </motion.div>
      ...
      <section className="px-8 mb-24">
        ...
        >
          ...
          <h2 className="text-2xl font-bold leading-tight">
            Our Core{" "}
            <span className="italic font-serif text-primary">Pillars</span>
          </h2>
        </motion.div>
          ...
          {[
            {
              ...
              desc: "Every service is a masterpiece, crafted with precision.",
            },
            {
              icon: <ShieldCheck size={24} />,
              title: "Safe Sanctuary",
              desc: "Highest medical-grade sanitization protocols.",
            },
            {
              icon: <Clock size={24} />,
              title: "Personalized Care",
              desc: "Bespoke rituals tailored uniquely to you.",
            },
          ].map((value, i) => (
            <motion.div
              key={i}
      ...
      <section className="py-10 px-8 mb-12">
        ...
        >
          ...
          <h2 className="text-3xl font-bold">
            Meet the{" "}
            <span className="italic font-serif text-primary">Experts</span>
          </h2>
        </motion.div>
      ...
      <section className="py-10 px-8 text-center bg-[#F4F1EC]">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold tracking-tight text-[#2B2B2B] mb-6">
            Ready to{" "}
            <span className="italic font-serif text-[#C9A24A]">Transform?</span>
          </h2>
          <p className="text-[#2B2B2B]/60 mb-10 max-w-xs mx-auto font-medium">
            Step into our sanctuary and let your radiant essence unfold.
          </p>
          <Link to="/contact">
            <motion.button
              whileHover={{ scale: 1.05 }}
